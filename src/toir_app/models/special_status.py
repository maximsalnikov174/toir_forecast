...
from constants import (
    SPECIAL_STATUS_FOR_CAR_COMMENT,
...
class SpecialStatusForCar(Base):
    """Связь специальных статусов ТС (`на ВР`, `после ДТП` итд) с самими ТС.

    ## Fields:
    - date_left: дата прекращения действия указанного статуса;
    - is_active: после прекращения действия проставляется `False`;
    - assigned_by_user_id: пользователь, установивший данный статус.
    """
